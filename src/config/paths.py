...
DADOS_CREDICARD = DATA_DIR / "credicard.csv.gz"  # Nome padronizado
DADOS_CREDICARD_TRATADO = DATA_DIR / "credicard_tratado.parquet"  # Exemplo

if not DADOS_CREDICARD.exists():
    raise FileNotFoundError(f"Arquivo não encontrado: {DADOS_CREDICARD}")
